...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["GRS-ESI","1. Les états d\'une demande de réservation","2. Guide de l\'administrateur","3. Guide du profil simple","4. Paramètres de l\'application","2.1. Première utilisation de l\'application","2.2. Présentation de l\'interface","2.3. Guide détaillé de chaque onglet","2.4. Fiche technique de l\'événement","3.1. Présentation de l\'interface","3.2. Guide détaillé de chaque onglet","3.3. Fiche technique de l\'événement","Début et fin de semestres","Modes local/en ligne","Administration","Réserver","Mes réservations","Historique des évenements","Notifications","Mon profil","Se déconnecter","Réserver","Statut de mes réservations","Historique des événements","Notifications","Mon profil","Se déconnecter","Gérer les réservations","Gérer les profils","Gérer le planning","Gérer les vacances","Tous les événements","Evenements annulés","Acceptées","En attente","Rejetées"],
    DREX_NODE_LINKS: ["index.htm","les_etats_d_une_demande_de_reservation.htm","guide_de_l_administrateur.htm","guide_du_profil_simple.htm","parametres_de_l_application.htm","premiere_utilisation_de_l_application.htm","presentation_de_l_interface_1.htm","guide_detaille_de_chaque_onglet_1.htm","fiche_technique_de_l_evenement_1.htm","presentation_de_l_interface_2.htm","guide_detaille_de_chaque_onglet_2.htm","fiche_technique_de_l_evenement_2.htm","debut_et_fin_de_semestres.htm","modes_local_en_ligne.htm","administration.htm","reserver_1.htm","mes_reservations.htm","historique_des_evenements_1.htm","notifications_1.htm","mon_profil_1.htm","se_deconnecter_1.htm","reserver_2.htm","statut_de_mes_reservations.htm","historique_des_evenements_2.htm","notifications_2.htm","mon_profil_2.htm","se_deconnecter_2.htm","gerer_les_reservations.htm","gerer_les_profils.htm","gerer_le_planning.htm","gerer_les_vacances.htm","tous_les_evenements.htm","evenements_annules.htm","acceptees.htm","en_attente.htm","rejetees.htm"],
    DREX_NODE_CHILD_START: [1,5,5,9,12,14,14,14,21,21,21,27,27,27,27,31,31,31,33,33,33,33,33,36,36,36,36,36,36,36,36,36,36,36,36,36],
    DREX_NODE_CHILD_END: [5,5,9,12,14,14,14,21,21,21,27,27,27,27,31,31,31,33,33,33,33,33,36,36,36,36,36,36,36,36,36,36,36,36,36,36],
    DREX_MENU_TYPE: 3,
...
DR_EXPLAIN.data_search = {
    ...
    DREXPLAIN_EMPTY_STRING: "Veuillez entrer une cha&#x00EE;ne pour la recherche !",
    DREXPLAIN_IN_PROGRESS: "Recherche...",
    DREXPLAIN_PREVIEW_MODE_SEARCH_IS_DISABLED_NOTICE : "En mode pr&#x00E9;visualisation, la recherche est d&#x00E9;sactiv&#x00E9;e.",
    DREXPLAIN_ERROR_LOCAL_SEARCH : "Google Chrome et Opera 12.02 et plus r&#x00E9;cents ne prennent pas en charge la recherche dans les fichiers HTML locaux. T&#x00E9;l&#x00E9;chargez vos fichiers vers le serveur web ou utilisez un autre navigateur."
