...
if (isset($_SESSION['privilege']) && $_SESSION['privilege'] == 1) {
    ?>
    <html>
    <head><title>Gérer les réservations</title>
        <meta charset="utf-8"/>
    ...
    <section class="section section-lg">
        <section class="section" style="margin-top: -50px;">
            <img src="./assets/img/path4.png" class="path" style="width: 900px;">
        </section>
    </section>
    <div class="container"
         style="background:papayawhip;border-radius: 20px; background-color: rgba(149,208,219,0.15) ;margin-top: -5%;width: 90%;">
        <center>
            <table class="table table-striped " style="width: 100%">
                ...
                creation_tmp_collision($bdd); // Création de la table temporaire des collisions (pour toutes les dates)
               ...
               $debut=($page_actuelle-1)*$nb_par_page;
                    $requete = $bdd->prepare('SELECT * FROM events WHERE valide=0 OR valide=2 ORDER BY id DESC');
                $requete->execute();
                $nb_results= $requete->rowCount();

                 $requete = $bdd->prepare('SELECT * FROM events WHERE valide=0 OR valide=2 ORDER BY id DESC LIMIT '.$debut.','.$nb_par_page);
                $requete->execute();
                ...
                if ($photo == 1) {
                    echo '<td><center><img src="avatars/' . $resultat['club_id'] . 'min.png' . '" width="24px"/><a style="color:white;">&nbsp;' . $resultat2['nom'] . '</a></center> </td>';
                ...
                echo '<td ><center><span class="badge badge-default" style="font-size:12px; ">Expiré</span></center></td>'; ?>
                <!-- Button trigger modal -->
                <?php echo '<td>
            <center>
                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#exampleModal' . $resultat['id'] . '4">
                    Supprimer
                </button>
            </center>
        </td>
        ...
        <!-- Modal -->
        <div class="modal fade" id="exampleModal' . $resultat['id'] . '4" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <?php echo '<a type="button" class="btn btn-info" href="supprimer_historique.php?id=' . $resultat['id'] . '&gerer=1" >OK</a>'; ?>
                        </div>
                    </div>
                </div>
    </div>
    ...
    <?php } else {
        ...
        echo '<td><center><span class="badge badge-warning" style="font-size: 12px;">En attente de validation</span></center></td>';
        if ($res_collision == NULL) {
            ...
            <center>
                <button type="button" class="btn btn-success" data-toggle="modal"
                        data-target="#exampleModal' . $resultat['id'] . '1">Valider
                </button>
            </center>
        </td>
        <!-- Modal -->
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <?php echo '<a class="btn btn-success" href="valider_event.php?id=' . $resultat['id'] . '">OK</a>'; ?>
                    </div>
                </div>
            </div>
            </div>
        <?php } else {
            echo '<td><center><a style="color: #e60000;font-size: 20px;"><strong>COLLISION</strong></a></center></td>';
        ...
        echo '<td>
            <center>
                <button type="button" class="btn btn-danger" data-toggle="modal"
                        data-target="#exampleModal' . $resultat['id'] . '2">Rejeter
                </button>
            </center>
        </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p id="mssg">Voulez-vous vraiment rejeter cet évènement ?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">
                        Annuler
                    </button>
                    <?php echo '<a class=" btn btn-danger" href="rejeter_event.php?id=' . $resultat['id'] . '">OK</a>'; ?>
                </div>
            </div>
        </div>
        </div>
    ...
    else // donc $resultat['valide']=2 (d'après la requête SQL)
    {
        echo '<td> <center><span class="badge badge-danger" style="font-size: 12px;" >Rejeté</span></center></td>'; ?>
        <!-- Button trigger modal -->
        <?php echo '<td>
            <center>
                <button type="button" class="btn btn-info" data-toggle="modal"
                        data-target="#exampleModal' . $resultat['id'] . '4">Supprimer
                </button>
            </center>
        </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <?php echo '<a class="btn btn-info" href="supprimer_historique.php?id=' . $resultat['id'] . '&gerer=1">OK</a>'; ?>
                </div>
            </div>
        </div>
        </div>
              ...
              <ul class="pagination pg-blue">
                ...
                if ($page_actuelle==1)
                {
                    ...
                    while (($cpt<=3) && ($cpt<=$nb_pages))
                    {
                        ...
                        {
                             echo '<li class="page-item active"><a href="gerer_reservations.php?page='.$cpt.'" class="page-link">'.$cpt.'</a></li>';
                        }
                        else
                        {
                            echo '<li class="page-item"><a href="gerer_reservations.php?page='.$cpt.'" class="page-link">'.$cpt.'</a></li>';
                        }
                        $cpt++;
                    ...
                    if ($nb_pages>3)
                    {
                        ?>
                            ...
                            <?php 
                                ...
                                ?>
                          <a href="gerer_reservations.php?page=<?php echo $nb_pages; ?>" class="page-link" aria-label="Next">
                        ...
                        else
                        {
                            ...
                            ?>
                                ...
                                <?php 
                                    ...
                                    ?>
                              <a class="page-link" href="gerer_reservations.php" aria-label="Previous">
