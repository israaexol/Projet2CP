...
if (isset($_SESSION['privilege'])) {
    ...
    <div class="wrapper">
        <div class="container"
             style="background:papayawhip;border-radius: 20px; background-color: rgba(149,208,219,0.15)  ;margin-top: 10%;width: 90%">
            <center>
               ...
               $requete = $bdd->prepare('SELECT * FROM events WHERE valide=1 ORDER BY date DESC');
                    $requete->execute();
                $nb_results= $requete->rowCount();

                 $requete = $bdd->prepare('SELECT * FROM events WHERE valide=1 ORDER BY date DESC LIMIT '.$debut.','.$nb_par_page);
                    $requete->execute();
                ...
                if ($nb_results%$nb_par_page >0) $nb_pages++;
                    ...
                    if ($photo == 1) {
                        echo '<td><center><img src="avatars/' . $resultat['club_id'] . 'min.png' . '" width="24px"/><a style="color:white;">&nbsp ' . $resultat2['nom'] . '</a></center></td>';
                    ...
                    echo '<td><center><span class="label label-pending">N\'a pas encore eu lieu</span></center></td>';
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <?php echo '<a class=" btn btn-warning" href="annuler_event.php?id=' . $resultat['id'] . '">OK</a>'; ?>
                </div>
            </div>
        </div>
    ...
    <?php echo'</div>'; } else {
        if (($_SESSION['privilege'] == 0) && ($resultat['club_id'] == $_SESSION['id'])) {

        echo ' <td>
            <center>
               <button type="button" class="btn btn-primary" data-toggle="modal"
                        data-target="#exampleModal' . $resultat['id'] . '1club">
                    Modifier les salles
                </button>
            </center>
        </td>
        ...
        <!-- Modal -->
        <div class="modal fade" id="exampleModal' . $resultat['id'] . '1club" tabindex="-1" role="dialog"
             aria-labelledby="exampleModalLabel" aria-hidden="true">'; ?>
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
            ...
            <center>
                <button type="button" class="btn btn-warning" data-toggle="modal"
                        data-target="#exampleModal' . $resultat['id'] . '2club">
                    Annuler l\'évènement
                </button>
            </center>
        </td>
        <div class="modal fade" id="exampleModal' . $resultat['id'] . '2club" tabindex="-1" role="dialog"
             aria-labelledby="exampleModalLabel" aria-hidden="true">'; ?>
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-footer">
                        ...
                        <?php echo '<a class="btn btn-warning" href="annuler_demande.php?id=' . $resultat['id'] . '&historique=1">Annuler l\'évenement</a>'; ?>
                    </div>
                </div>
            </div>
        ...
        echo '<td><center><span class="label label-success">S\'est déroulé, archivé</span></center></td>';
        if ($_SESSION['privilege'] == 1) {
            echo '<td>
                    <center>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <?php echo '<a class="btn btn-info" href="supprimer_historique.php?id=' . $resultat['id'] . '">OK</a>'; ?>
                    </div>
                </div>
            </div>
              ...
              <ul class="pagination pg-blue">
                ...
                if ($page_actuelle==1)
                {
                    ...
                    while (($cpt<=3) && ($cpt<=$nb_pages))
                    {
                        ...
                        {
                             echo '<li class="page-item active"><a href="historique_events.php?page='.$cpt.'" class="page-link">'.$cpt.'</a></li>';
                        }
                        else
                        {
                            echo '<li class="page-item"><a href="historique_events.php?page='.$cpt.'" class="page-link">'.$cpt.'</a></li>';
                        }
                        $cpt++;
                    ...
                    if ($nb_pages>3)
                    {
                        ?>
                            ...
                            <?php 
                                ...
                                ?>
                          <a href="historique_events.php?page=<?php echo $nb_pages; ?>" class="page-link" aria-label="Next">
                        ...
                        else
                        {
                            ...
                            ?>
                                ...
                                <?php 
                                    ...
                                    ?>
                              <a class="page-link" href="historique_events.php" aria-label="Previous">
