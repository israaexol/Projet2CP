...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["GRS-ESI","1. Les états d\'une demande de réservation","2. Guide du profil simple","2.1. Présentation de l\'interface","2.2. Guide détaillé de chaque onglet","2.3. Fiche technique de l\'événement","Réserver","Statut de mes réservations","Historique des événements","Notifications","Mon profil","Se déconnecter","Acceptées","En attente","Rejetées"],
    DREX_NODE_LINKS: ["index.htm","les_etats_d_une_demande_de_reservation.htm","guide_du_profil_simple.htm","presentation_de_l_interface.htm","guide_detaille_de_chaque_onglet.htm","fiche_technique_de_l_evenement.htm","reserver.htm","statut_de_mes_reservations.htm","historique_des_evenements.htm","notifications.htm","mon_profil.htm","se_deconnecter.htm","acceptees.htm","en_attente.htm","rejetees.htm"],
    DREX_NODE_CHILD_START: [1,3,3,6,6,12,12,12,15,15,15,15,15,15,15],
    DREX_NODE_CHILD_END: [3,3,6,6,12,12,12,15,15,15,15,15,15,15,15],
    DREX_MENU_TYPE: 3,
